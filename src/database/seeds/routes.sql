...
-- 7. Інший водій (тепер driver_id = 4)
('2025-03-01', 3, 4, 'Warszawa', 'Gdańsk', 'B-201', 340, 4.50, 'planned'),

-- 8. Інше авто (тепер driver_id = 4)
('2025-03-02', 4, 4, 'Gdańsk', 'Sopot', 'B-202', 15, 0.50, 'completed');